...
io.on('connection', function(socket){
  ...
  socket.on('chat message', function(msg){
    if(msg.indexOf('.jpg') >=0)
      socket.emit('chat message',"<img class='sticker'src='../stickers/"+msg+" ' "+ "alt='alt' style='width:100px;height:100px'>");    
    else
...
var bot_response = ['I Care (´･ω･｀)', 
                    ...
                    '<img src="../stickers/itsok.jpg" alt="My_Logo" style="width:100px;height:100px">'];
